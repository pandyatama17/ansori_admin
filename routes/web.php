...
*/
    ...
    Auth::routes();
    Route::get('/', [SiswaController::class,'addSiswa'])->name('index');
    ...
    Route::get('/beban/referensi/pmb/form', [PmbController::class,'PmbRefForm'])->name('form_referensi_pmb');
    ...
    Route::post('/ajaxHandler/referensi/pmb/submit', [PmbController::class,'PmbRefSubmit'])->name('submit_pmb_ref');
