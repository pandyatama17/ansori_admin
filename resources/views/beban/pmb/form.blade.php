                    ...
                    <ul class="collapsible col s12 m7" style="padding-left:0; padding-right:0">
                        <li class="active">
                            ...
                            <div class="collapsible-body white">
                                ...
                                <div class="input-field col m4 s6">
                                    <label for="startDateGel1">Tanggal Mulai Gelombang 1:<span class="red-text">*</span></label>
                                    <input type="text" class=" datepicker" id="startDateGel1" name="start_date_gel1">
                                </div>
                                <div class="input-field col m4 s6">
                                    <label for="endDateGel1">Tanggal Akhir Gelombang 1:<span class="red-text">*</span></label>
                        ...
                        <li class="active">
                            ...
                            <div class="collapsible-body white">
                                ...
                                <div class="input-field col m4 s6">
                                    <label for="startDateGel2">Tanggal Mulai Gelombang 2:<span class="red-text">*</span></label>
                                    <input type="text" class=" datepicker" id="startDateGel2" name="start_date_gel2">
                                </div>
                                <div class="input-field col m4 s6">
                                    <label for="endDateGel2">Tanggal Akhir Gelombang 2:<span class="red-text">*</span></label>
                        ...
                        <li class="active">
                            ...
                            <div class="collapsible-body white">
                                ...
                                <div class="input-field col m4 s6">
                                    <label for="startDateGel3">Tanggal Mulai Gelombang 2:<span class="red-text">*</span></label>
                                    <input type="text" class=" datepicker" id="startDateGel3" name="start_date_gel3">
                                </div>
                                <div class="input-field col m4 s6">
                                    <label for="endDateGel3">Tanggal Akhir Gelombang 2:<span class="red-text">*</span></label>
